    ...
    <Stack width={maxWidth1144 ? '100%' : '55%'} mt={4}>
      ...
      >
        ...
        <Stack width="fit-content" justifyContent="center" alignItems="center">
          <Stack width={168} height={168} zIndex={1} justifyContent="center" alignItems="center">
            <Stack direction="row" alignItems="center">
              <InfoOutlinedIcon sx={{ color: colors.NEUTRAL300, width: 16 }} />
              <Typography color={colors.NEUTRAL300} fontSize={8} fontWeight={600} ml={0.2}>
                How to become human
              </Typography>
            </Stack>
            <Typography
            ...
            <Typography color={colors.NEUTRAL300} fontWeight={600} borderTop={`1px solid ${colors.NEUTRAL300}`}>
...
conic-gradient(${percentageScore === 100 ? '#06c954' : '#DD3345'} ${percentageScore}%, #DBDBDB 0)`,
        ...
        {/* Right Content */}
        <Stack ml={maxWidth700 ? 0 : 4} mt={maxWidth700 ? 2 : 0} alignItems={maxWidth700 ? 'center' : 'flex-start'}>
          <Stack direction={maxWidth480 ? 'column' : 'row'} alignItems="center" mb={2}>
            <PersonIcon sx={{ width: 28, height: 28, mt: -0.5, mr: 1 }} />
            <Typography fontSize={18} fontWeight={700} lineHeight="normal" mr={2}>
              My Humanity Score
            </Typography>
            <Tag
